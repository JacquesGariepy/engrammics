...
\midrule
Interference-free superposition (general) & not supported & DeltaNet (shared keys) \\
Surgical forgetting (general) & not supported & DeltaNet (shared keys) \\
Multi-step / compositional procedural transfer & not shown & --- \\
Transfer across \emph{distinct} checkpoints & not shown & only toy alignment \\
